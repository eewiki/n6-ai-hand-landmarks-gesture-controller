...
#define USBD_PRODUCT_STRING           "STM32 HID CDC"
#define USBD_CONFIGURATION_STRING     "HID CDC Config"
#define USBD_INTERFACE_STRING         "HID CDC Interface"
...
USBD_DescriptorsTypeDef CMPST_Desc =
{
